...
class Parser(object):
    def __init__(self):
        self.VERBOSE = True
        self.fast5_base_dir = '../MNT_train/MNT_local/fast5/'
        self.temp_dir = './tmp/'
        self.train_input_dir = '../MNT_train/MNT_low_input/'
        self.temp_file = 'temp_50_reads.fasta'
        self.genome_fn = '../train/NC_000913.3_ecoli_k12_MG1655.fasta'
        ...
        self.failed_reads_filename = 'UBC_failed_reads.txt'
...
if __name__ == '__main__':
    ...
    for fast5_fn_sg in fast5_fns:
        ...
        try:
            ...
            os.remove('../train/NC_000913.3_ecoli_k12_MG1655.fasta.gmidx')
